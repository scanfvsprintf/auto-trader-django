...
class SelectionService:
    ...
    def initialize_strategy():
        ...
        parameters_to_define = {
            ...
            'dynamic_miopmaop_k_gap_base_mt': {'value': '0.7', 'group': 'MIOPMAOP_BASE', 'desc': '动态开盘区间-趋势动能-高开容忍度'},
            'dynamic_miopmaop_k_drop_base_mt': {'value': '0.2', 'group': 'MIOPMAOP_BASE', 'desc': '动态开盘区间-趋势动能-低开容忍度'},
            'dynamic_miopmaop_k_gap_base_bo': {'value': '2.0', 'group': 'MIOPMAOP_BASE', 'desc': '动态开盘区间-强势突破-高开容忍度'},
            'dynamic_miopmaop_k_drop_base_bo': {'value': '0.1', 'group': 'MIOPMAOP_BASE', 'desc': '动态开盘区间-强势突破-低开容忍度'},
            'dynamic_miopmaop_k_gap_base_mr': {'value': '0.1', 'group': 'MIOPMAOP_BASE', 'desc': '动态开盘区间-均值回归-高开容忍度'},
            'dynamic_miopmaop_k_drop_base_mr': {'value': '2.0', 'group': 'MIOPMAOP_BASE', 'desc': '动态开盘区间-均值回归-低开容忍度'},
            'dynamic_miopmaop_k_gap_base_qd': {'value': '0.2', 'group': 'MIOPMAOP_BASE', 'desc': '动态开盘区间-质量防御-高开容忍度'},
            'dynamic_miopmaop_k_drop_base_qd': {'value': '0.2', 'group': 'MIOPMAOP_BASE', 'desc': '动态开盘区间-质量防御-低开容忍度'},
